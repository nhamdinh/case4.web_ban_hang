...
public class ApplicationConfiguration extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/phhaisan?useUnicode=true&characterEncoding=UTF-8");
    ...
    @Bean
    public PhanloaiService phanloaiService() {
        return new PhanloaiServiceImpl();
    }
